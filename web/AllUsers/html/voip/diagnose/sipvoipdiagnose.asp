...
<tr><td class="width_100p align_left func_title" BindText='vspa_outlinetext'></td> </tr> 
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_button"> 
  <tr> 
    ...
    <td class="table_submit align_left">
        <input name="startOutLineTest" id="startOutLineTest" type="button" class="ApplyButtoncss buttonwidth_100px" value="Start Test" onClick="SubmitStartOutLineTest();"/>
        ...
        <input name="getLineTestResult" id="getLineTestResult" type="button" class="ApplyButtoncss buttonwidth_100px" value="Get Result" onClick="SubmitGetOutLineTestResult();"/>
        <script type="text/javascript">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabal_head"> 
<tr><td class="func_title" width="100% align_left" BindText='vspa_innerlinetest'></td></tr> 
</table> 
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="tabal_bg">
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table_button"> 
  <tr> 
    ...
    <td class="table_submit align_left">
		...
		<input name="startInnerLineTest" id="startInnerLineTest" type="button" class="ApplyButtoncss buttonwidth_100px" value="Start Test" onClick="SubmitStartInnerTest();"/>
	<script type="text/javascript">
	...
	<input name="getInnerLineTestResult" id="getInnerLineTestResult" type="button" class="ApplyButtoncss buttonwidth_100px " value="Get Result" onClick="SubmitGetInnerTestResult();"/>
	<script type="text/javascript">
