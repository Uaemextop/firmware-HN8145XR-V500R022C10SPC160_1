...
function RedirectPingResult()
{
    ...
    {
        document.location = "h248voipinterface.asp";
    }
    else
    {
        if (CfgMode.toUpperCase() == 'GLOBALFTTR') {
            document.location = "globesipvoipinterface.asp";
        } else {
            document.location = "sipvoipinterface.asp";
        }
    }
}
