...
<head>
  ...
  <script language="javascript">
    ...
    var loadedcolor = '#DE4901';
    var unloadedcolor = '#FCEAC1';
    var bordercolor = '#FCEAC1';
    ...
    if (ns4) {
      ...
      htmltxt += '<ilayer name="PBouter" height="' + progressheight + '" width="' + progresswidth + '" style="display:none;">';
      ...
      htmltxt += '<layer name="PBdone" width="' + (progresswidth - 2) + '" height="' + (progressheight - 2) + '" style=" top:1px; left:1px; background-color:' + loadedcolor + '; "></layer>';
      htmltxt += '</ilayer>';
      htmltxt += '</td></tr></table>';
    } else {
      htmltxt += '<div id="PBouter" style="position:relative; display:none; background-color:' + bordercolor + '; width:' + progresswidth + 'px; height:' + progressheight + 'px;">';
      ...
      htmltxt += '<div id="PBdone" style="position:absolute; top:1px; left:1px; width:0px; height:' + (progressheight - 2) + 'px; background-color:' + loadedcolor + '; font-size:1px;"></div>';
      htmltxt += '</div>';
    }
    ...
    ***********************************/
    ...
    function StartRegStatus() {
      ...
      document.getElementById("frontpic").style.display = 'none';
      if (CfgMode.toUpperCase() == "LNCU") {
        document.getElementById("regResult").innerHTML = "终端正在向OLT注册。";
      }
      else {
          ...
          if (Wan.length == 0) {
            ...
            for (i = 0; i < Wan.length; i++) {
              ...
              if ((Wan[i].ConnectionStatus == "Connected") &&
                ...
                if (CfgMode.toUpperCase() == "LNCU") {
                  document.getElementById("regResult").innerHTML = "终端获取管理地址成功，正在注册RMS管理平台。";
                }
                else {
                  document.getElementById("regResult").innerHTML = "已获得管理IP，正在连接RMS。";
                }
                break;
              }
              else {
      ...
      if (Infos != null) {
        ...
        if (parseInt(Infos.Status) == 0) {
          ...
          if (parseInt(Infos.Result) == 99) {
            ...
            document.getElementById("frontpic").style.display = 'none';
            if (GetDateTimeDiff() > 300) {
              document.getElementById("regResult").innerHTML = "注册RMS超过300秒，请耐心等待或者返回重试。";
              return;
            }

            if (CfgMode.toUpperCase() == "LNCU") {
              document.getElementById("regResult").innerHTML = "终端注册RMS管理平台成功，等待RMS平台下发业务数据。";
            }
            else {
              document.getElementById("regResult").innerHTML = "注册成功，等待RMS平台下发业务数据。";
            }
          }
            ...
            document.getElementById("frontpic").style.display = 'none';
            if (GetDateTimeDiff() > 300) {
              document.getElementById("regResult").innerHTML = "RMS下发业务超过300秒，请耐心等待或者返回重试。";
              return;
            }
            ...
            if (CfgMode.toUpperCase() == "LNCU") {
              ...
              document.getElementById("regResult").innerHTML = "RMS平台正在下发业务数据，请勿断电或拔线。";
            }
          }
            ...
            document.getElementById("frontpic").style.display = 'none';
            if (CfgMode.toUpperCase() == "LNCU") {
              document.getElementById("regResult").innerHTML = "注册全部完成，业务下发配置成功，欢迎使用辽宁联通的通信业务。";
            }
            else {
...
<body onLoad="LoadFrame();" font style="font-size: 14px;">
  <form>
    <div align="center">
      <TABLE cellSpacing="0" cellPadding="0" align="center" border="0" font style="font-size: 14px;">
        <TBODY>
          <TR>
          </TR>
          <TR>
            <TD>
              <TABLE cellSpacing="0" cellPadding="0" align="middle" border="0" font style="font-size: 14px;">
                <TBODY>
                  <TR>
                    <script type="text/javascript" language="javascript">
                      if ('LNCU' == CfgMode.toUpperCase()) {
                        document.write('<TD align="center" style="background-image:url(/images/cu_register_cubg.jpg); background-repeat:no-repeat;width:935px;height:417px;">');
                      }
                      else {
                        document.write('<TD align="center" style="background-image:url(/images/register_cubg.gif); background-repeat:no-repeat;width:935px;height:417px;">');
                      }
                    </script>
                    <TABLE cellSpacing="0" cellPadding="0" width="96%" height="15%" border="0" font
                    ...
                    <div
                      style="position:relative; top:20px;left:-200px;height:20px; width:120px;font-family: '微软雅黑';font-size:20px;font-weight:bolder;color: #3c1400;"
                      id="userpwd_txt">逻辑ID注册</div>
                    <br>
                    <TABLE cellSpacing="0" cellPadding="0" width="400" border="0" height="80%">
                      <TR>
                        <TD colspan="2" align="center">
                          <div id="prograss"><span id="percent"
                              style="font-family: '微软雅黑';font-size:12px;font-weight:bolder;"></span></div>
                        </TD>
                      </TR>
                      <TR>
                        <TD colspan="2" align="center">
                      ...
                      <TR style="height:auto">
                        <TD colspan="2" align="center"><img id="frontpic" width="37" height="37" style="display:none" />
                          <span style="position:relative; top:-10px;">
                            <font id="regResult"
                              style="font-family: '微软雅黑';font-size:18px; color:3C1400;font-weight:bold; padding-bottom:10px">
                            </font>
                          </span>
                        </TD>
                      </TR>
