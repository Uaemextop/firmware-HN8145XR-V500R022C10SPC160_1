...
{ 
	...
	{ 
		document.getElementById('loidretbody').style.display = "none";
...
<body  class="mainbody" onLoad="LoadFrame();"id="loidretbody">
<table width="100%" height="10%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td class="prompt">
			...
			{
			    document.write("烧制loid成功。");
		        }
			else
			{
			    document.write("烧制loid失败。");
			}
			</script>		
		    </td>
                </tr>
