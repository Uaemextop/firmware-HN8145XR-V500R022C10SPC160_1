...
<head>
  ...
  <style type="text/css">
    div#mainpage {
      ...
      margin: 0px auto;
      background-image: url(/images/cu_adminbg.jpg);
    }
    ...
    .statuslink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initstatus.gif);
    }

    a.statuslink:hover {
      background-image: url(/images/cu_overstatus.gif);
    }
    ...
    .basiclink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initbasic.gif);
    }

    a.basiclink:hover {
      background-image: url(/images/cu_overbasic.gif);
    }
    ...
    .advancelink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initadvance.gif);
    }

    a.advancelink:hover {
      background-image: url(/images/cu_overadvance.gif);
    }
    ...
    .decivelink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initdevice.gif);
    }

    a.decivelink:hover {
      background-image: url(/images/cu_overdevice.gif);
    }
    ...
    .quicklink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initquick.gif);
    }

    a.quicklink:hover {
      background-image: url(/images/cu_overquick.gif);
    }
    ...
    .helplink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_inithelp.gif);
    }

    a.helplink:hover {
      background-image: url(/images/cu_overhelp.gif);
    }
    ...
    .quitlink {
      ...
      height: 55px;
      width: 119px;
      background-image: url(/images/cu_initquit.gif);
    }

    a.quitlink:hover {
      background-image: url(/images/cu_overquit.gif);
    }
  ...
  <script language="JavaScript" type="text/javascript">
    ...
    if (CfgMode.toUpperCase() != 'LNCU') {
      window.location = "/CtcApp/preindex.asp";
    }
        ...
        <table width="100%" id="prebutton">
          ...
          <tr>
            <table width="100%">
              <tr>
                <td width="180px"></td>
                <td><a id="helplink" name="helplink" href="#" class="helplink" onclick="HelpGuide();"></a></td>
              </tr>
              <table>
          </tr>
          <tr>
