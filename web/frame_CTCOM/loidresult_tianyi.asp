    ...
    if (CheckLoidFailForCT()) {
      ...
      if (1 == Mngtct) {
        if (GetDateTimeDiff() > 300) {
          document.getElementById("regResult").innerHTML = "到ITMS的通道不通，请联系客户经理或拨打" + TelNum + "。";
          clearTimeout(timer);
        ...
        if (GetDateTimeDiff() > 300) {
          ...
          for (i = 0; i < Wan.length; i++) {
            if ((Wan[i].ConnectionStatus == "Connected" && Wan[i].X_HW_SERVICELIST.indexOf("TR069") != -1)
              || ((Wan[i].X_HW_SERVICELIST.indexOf("TR069") != -1) && (Wan[i].ConnectionStatus == "Connected") && ("RITMS" == CurrentRegisterStep))) {
              document.getElementById("regResult").innerHTML = "注册ITMS平台失败，请联系10000号。"; //更改了ACS URL
              LoidRegResultLog("ITMS_CfgFail");
              break;
            }
            else {
          ...
          <TABLE cellSpacing="0" cellPadding="0" width="96%" height="15%" border="0">
            <TR>
              <TD align="right">
                <script language="javascript">
                  if (1 != simcardstatus) {
                    document.write('<A href="http://' + br0Ip + ':' + httpport + '/maintain"><font style="font-size: 14px;" color="#000000">返回上一级</FONT></A>');
                  }
                </script>
              </TD>
            </TR>
                ...
                if (1 == MngtFjct || 1 == MngtCqct || 1 == Mngtct) {
                  ...
                  if (ontPonMode == 'gpon' || ontPonMode == 'GPON') {
                    if (1 == IsRhGateway) {
                      ...
                      document.write('<TD align="left" colSpan="2" height="25" style="font-size: 13px;">GPON的E8-C终端注册</TD>');
                    }
                  }
                  else {
                    if (1 == IsRhGateway) {
                      ...
                      document.write('<TD align="left" colSpan="2" height="25" style="font-size: 13px;">EPON的E8-C终端注册</TD>');
                    }
                  }
                  document.write('</TR>');
                  ...
                  if (ontPonMode == 'gpon' || ontPonMode == 'GPON') {
                    if (1 == IsRhGateway) {
                      if (1 == E8CRONGHEFlag) {
                        document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">GPON宽带融合终端</strong></TD>');
                      }
                      else {
                        document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">GPON上行融合智能终端</strong></TD>');
                      }
                    }
                    else if (1 == IsCTRG) {
                      document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">GPON上行天翼网关</strong></TD>');
                    }
                    else {
                      document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">GPON上行E8-C终端</strong></TD>');
                    }
                  }
                  else {
                    if (1 == IsRhGateway) {
                      if (1 == E8CRONGHEFlag) {
                        document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">EPON宽带融合终端</strong></TD>');
                      }
                      else {
                        document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">EPON上行融合智能终端</strong></TD>');
                      }
                    }
                    else if (1 == IsCTRG) {
                      document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">EPON上行天翼网关</strong></TD>');
                    }
                    else {
                      document.write('<TD align="middle" colSpan="2" height="25" style="font-size: 18px;"><strong style="color:#FF0033">EPON上行E8-C终端</strong></TD>');
                    }
                  }
                  document.write('</TR>');
