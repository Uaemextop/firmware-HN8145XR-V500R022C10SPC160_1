...
<script type="text/javascript">
  ...
  if (CfgFtWordArea.toUpperCase() != 'CHOOSE') {
    window.location = 'http://' + br0Ip + ':' + httpport + '/loidchooseareaTyEx.asp';
  }
  ...
  function LoadFrame() {
    if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|wOSBrowser|BrowserNG|WebOS)/i))) {
      ...
      document.getElementById("background").style = "background-image:url(/images/register_gdinfo_forphone.gif); width:" + window.innerWidth + "px; height:" + window.innerHeight + "px; background-size:100% 100%; background-repeat: no-repeat; position:relative;"
      $('#bgtbl1').css({"width":"100%","height":"100%","margin":"0"});
      $('#bgtbl2').css({"width":"100%","height":"100%","margin":"0"});

      $('#CheckPwdModule').css({"margin-top":-100 * prop + "px"});
      $('#inputpwdtitle').css({"position":"absolute","margin-top":-50 * prop + "px","left":80 * prop + "px","font-size":0.7 * prop + "rem","text-align":"center"});
      $('#inputpwdnotice').css({"font-size":0.7 * prop + "rem"});
      ...
      $('#servicenotice').css({"margin-left":-55 * prop + "px","position":"absolute","margin-top":30 * prop + "px","font-size":0.6 * prop + "rem","text-align":"center"});

      $('.submit_area').css({"width":80 * prop + "px","height":45 * prop + "px","margin-bottom":18 * prop + "px","font-size":1.4 * prop + "rem","text-align":"center"});
      $('#ChooseAreaModule').css({"height": 0.6 * window.innerHeight + "px","width":"80%","font-size":prop + "rem", "text-align": "center"});
      $('#selecttitle').css({"position":"absolute","text-align": "center","top":120 * prop + "px","margin-left":-60 * prop + "px","font-size":prop + "rem"});

      $('#0451').css("font-size",1.2 * prop + "rem");
      $('#0471').css("font-size",1.2 * prop + "rem");
      $('#backtologin').css({"position":"absolute","top":120 * prop + "px","margin-left":-8 * prop + "px","margin-right":20 * prop + "px","font-size":1.1 * prop + "rem"});
    }
  }
</script>
...
<body onLoad="LoadFrame();">
  <form>
    <div align="center">
      <table id="bgtbl1" cellSpacing="0" cellPadding="0" width="808" align="center" border="0">
        <TBODY>
          <TR>
            <script language="JavaScript" type="text/javascript">
              if ('CMCC' == CfgMode.toUpperCase()) {
          ...
          <TR>
            <TD>
              <table id="bgtbl2" width="808" height="323" border="0" align="center" cellpadding="0" cellspacing="0"
                style="margin-top: -5px;">
                <TBODY>
                  <TR>
                    <script language="javascript">
                      if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|wOSBrowser|BrowserNG|WebOS)/i))) {
                        document.write('<TD id="background" align="center" background="/images/register_gdinfo_forphone5.jpg">');
                      } else {
                        document.write('<TD width="77" background="/images/bg.gif" rowSpan="3">');
                    ...
                    <div id="ChooseAreaModule" class="module" align="justify"
                      ...
                      <p class="header">
                        <font id="selecttitle" style="font-size: 14px;">请选择所在地区:</font>
                      </p>
                    ...
                    <div id="CheckPwdModule" class="module" style="display:none;font-size: 16px;">
                      ...
                      <p align="center">
                        <font id="inputpwdtitle" style="font-size: 16px;">输入管理员密码后可选择省份</font>
                      </p>
                      <p align="center">
                        <font id="inputpwdnotice" style='font-size: 16px;'>验证密码：</font> <input type="password" autocomplete="off"
                      ...
                      <script language="javascript">
                        if ('CMCC' == CfgMode.toUpperCase()) {
                          document.write('<p style="text-align:center;"> <font id="servicenotice" style="font-size: 13px;">中国移动客服热线10086号</font></p>');
                        }
                        else {
                          document.write('<p style="text-align:center;"> <font id="servicenotice" style="font-size: 13px;">中国电信客服热线10000号</font></p>');
                        }
                      </script>
                    </div>
      ...
      <script language="javascript">
        if ((!navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|wOSBrowser|BrowserNG|WebOS)/i))) {
          document.write('<TD width="78" background="/images/bg.gif" rowSpan="3">');
        }
      </script>
    </TR>
    </TBODY>
      ...
      <table class="prompt">
        <TR>
          ...
          <TD align="right" width="20%">
            <script language="javascript">
              document.write('<A href="http://' + br0Ip + ':' + httpport + '/login.asp"><font id="backtologin" style="font-size: 13px;" color="#000000">返回登录页面</FONT></A>');
            </script>
          </TD>
      ...
      if (window.location.host.indexOf(br0Ip) > -1) {
        ...
        if (regHW == "DONEHW") {
          ...
          if (DestChooseArea == "022") {
            ...
            window.location = 'http://' + window.location.host + "_Register";
          }
        }
      }
    }
      ...
      viewModel.$ChooseAreaModule.delegate(':button', 'click', function () {
        ...
        start: function (event, backable) {
          ...
          if (backable === "noback") {
            ...
            if (!gobackBtn.length) {
              if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|wOSBrowser|BrowserNG|WebOS)/i))) {
                viewModel.$ChooseAreaModule.append("<font style='font-size:' + window.innerWidth / 440 + 'rem;'><a class='goback' href='#'>返回&gt;&gt;</a></font>");
              } else {
        ...
        endProgress: function () {
          ...
          var tempInterval = setInterval(function () {
            ...
            if (redirectSeconds !== 0) {
              ...
              var TimeOutInterval = setTimeout("endProgressJump()", 5000);
            }
          }, 1000);
        }
      });
