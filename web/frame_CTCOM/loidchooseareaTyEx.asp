...
<script type="text/javascript">
  ...
  function LoadFrame() {
    if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|wOSBrowser|BrowserNG|WebOS)/i))) {
      ...
      $('#ChooseAreaModule').css({"height": 0.6 * window.innerHeight + "px","width":"100%","margin-top":-120 * prop + "px","font-size":prop + "rem", "text-align": "center"});
      $('#selecttitle').css({"position":"absolute","text-align": "center","bottom":700 * prop + "px","margin-left":-60 * prop + "px","font-size":prop + "rem"});
...
<body onLoad="LoadFrame();">
  <form>
          ...
          <TR>
            <TD>
              <table width="808" height="323" border="0" align="center" cellpadding="0" cellspacing="0"
                ...
                <TBODY>
                  <TR>
                    <TD id="leftborder" width="77" background="/images/bg.gif" rowSpan="3"></TD>
                    <script language="javascript">
    ...
    <TD id="rightborder" width="78" background="/images/bg.gif" rowSpan="3"></TD>
    </TR>
    </TBODY>
    </TABLE>
    </TD>
