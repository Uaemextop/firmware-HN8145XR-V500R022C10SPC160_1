  ...
  <form>
    <div align="center">
      <TABLE cellSpacing="0" cellPadding="0" width="808" align="center" border="0">
        <TBODY>
          <TR>
            <TD><IMG height="137" src="/images/register_banner_cmcc.jpg" width="808"></TD>
          </TR>
          <TR>
            <TD>
                ...
                <TBODY>
                  <TR>
                    ...
                    <script language="javascript">
                      ...
                      document.write('</TR>');
                      document.write('<TR><TD align="middle" colSpan="2"><font style="font-size: 14px;">提示：输入的验证密码不正确，请找支撑经理从RMS平台获取。</font></TD></TR>');
                    </script>
                  <TR height="8">
                  ...
                  <TR>
                    <TD align="center" colSpan="2" width="100%" height="20">
                      <font style="font-size: 14px;">中国移动客服热线10086号</font>
                    </TD>
                  </TR>
                  <TR>
