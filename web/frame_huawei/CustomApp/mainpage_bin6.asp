...
function stRepeaterInfo(SSID,Channel,Rate_RX,Rate_TX,MCS_RX,MCS_TX,ChannelWidth,RSSI)
{
	this.SSID = SSID;
...
function loadframe()
{
	...
	document.getElementById('linedevline').style.display ='none';
...
<span id="InterNetDes" class="InternetSpanLeftText"></span><span id="InterNetStatusText" class="InternetSpanRightText"></span></div>
...
<div id="wifipage" >
	...
	if(apcmodefeature == 1)
	{
		document.write('<iframe id="Showwifimode" frameborder="0" width="100%" height="495px" marginheight="0" marginwidth="0" src="/html/amp/wlaninfo/wlanupmode.asp" style="overflow-y: scroll;"></iframe>');
	}
	</script>
</div>
</div>
