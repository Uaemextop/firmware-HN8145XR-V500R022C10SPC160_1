...
var ErrInfo = getErrStrId(ErrCode);
function getErrStrId(ErrStr)
{
    if ((cfgMode === 'ROSUNION') && (ErrStr === '0xf7205016')) {
      return SambaLgeDes['s1457'];
    }
...
function LoadFrame() 
{
    ...
    if (cfgMode === 'DESKAPASTRO') {
      document.getElementById('errorImg').src = "../../../images/error_astro.png";
      document.getElementById('errorMsg').style.color = "red";
    }

    if ((cfgMode == "GDCMCC_RMS") && (ErrCode == "0xf7104022")) {
