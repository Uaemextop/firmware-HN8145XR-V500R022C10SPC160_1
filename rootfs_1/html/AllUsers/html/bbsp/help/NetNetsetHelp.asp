  ...
  <tr>
    ...
    <script language="JavaScript" type="text/javascript">
        if (false == nethelpIsBin5Board){
            ...
            document.write("<tr><td>&nbsp;<td>IPTV</td><td>专用于IPTV</td></tr>");
            document.write("<tr><td>&nbsp;<td>VOICE_IPTV</td><td>同时用于宽带语音和IPTV</td></tr>");
            document.write("<tr><td>&nbsp;<td>TR069_IPTV</td><td>同时用于远程网管和IPTV</td></tr>");
            document.write("<tr><td>&nbsp;<td>TR069_VOICE_IPTV</td><td>同时用于远程网管、宽带语音和IPTV</td></tr>");
        }
    </script>
</table>
</blockquote>
