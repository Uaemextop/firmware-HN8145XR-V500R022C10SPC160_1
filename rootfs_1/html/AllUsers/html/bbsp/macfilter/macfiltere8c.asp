...
function showFilterTips()
{
    ...
    if (ExcludeMode_select[0].selected == true) {
        if (fttrSupport == '1') {
            getElement('ExcludeMode_tips_lable').innerHTML = macfilter_language['bbsp_macfilternotefttr1'];
        } else {
            getElement('ExcludeMode_tips_lable').innerHTML = macfilter_language['bbsp_macfilternote1'];
        }
    } else {
        if (fttrSupport == '1') {
            getElement('ExcludeMode_tips_lable').innerHTML = macfilter_language['bbsp_macfilternotefttr2'];
        } else {
            getElement('ExcludeMode_tips_lable').innerHTML = macfilter_language['bbsp_macfilternote2'];
        }
    }
}
function ChangeMode()
