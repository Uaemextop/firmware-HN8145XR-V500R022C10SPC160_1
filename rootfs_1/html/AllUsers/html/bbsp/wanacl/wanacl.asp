...
<script>
    ...
    function OnPageLoad()
    {
        ...
        if (CfgModeWord.toUpperCase() == 'SAFARICOM2') {
            setDisplay("TD_cb_TELNET", 0);
            setDisplay("TD_cb_SSH", 0);
            setDisplay("TD_cb_HTTP", 0);
            setDisplay("TD_cb_FTP", 0);
        ...
        <div id="Div_TELNET">
          <table>
              <tr>
                <script>
                    if (CfgModeWord.toUpperCase() != 'SAFARICOM2') {
                        document.write('<td id="TD_cb_TELNET">' + '<input id="cb_TELNET" name="cb_TELNET" type="checkbox" value="TELNET">' + 'TELNET' + '</td>');
                        document.write('<td id="TD_cb_SSH">' + '<input id="cb_SSH" name="cb_SSH" type="checkbox" value="SSH">' + 'SSH' + '</td>');
                        document.write('<td id="TD_cb_HTTP">' + '<input id="cb_HTTP" name="cb_HTTP" type="checkbox" value="HTTP">' + 'HTTP' + '</td>');
                        document.write('<td id="TD_cb_FTP">' + '<input id="cb_FTP" name="cb_FTP" type="checkbox" value="FTP">' + 'FTP' + '</td>');
                    }
                </script>
