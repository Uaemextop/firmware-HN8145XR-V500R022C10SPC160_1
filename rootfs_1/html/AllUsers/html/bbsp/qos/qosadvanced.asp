...
<script language="javascript" src="../../bbsp/common/<%HW_WEB_CleanCache_Resource(wan_servicelist.js);%>"></script>
...
if (true == CmccFlag)
{
	var ClassificationTypeInfoList = QosClassificationInfoAdaptor(ClassificationTypeInfoList);
}
...
function getLanTopoRange()
{
	...
	if (WlanInfoList.length -1 > 0)
	{
		...
		{
			var idex = parseInt(WlanInfoList[i].Domain.charAt(WlanInfoList[i].Domain.length - 1), 10);
		...
		<div id="QosDataClassConfigForm">
			<table cellpadding="0" cellspacing="0" border="0" id="Class_cfg_table" width="100%"> 
				<tr id="DataClassIdListTr">
					<td  class="table_title width_25p" BindText='bbsp_DataClassIdmh' width="198"></td> 
				...
				<tr>
					<td  class="table_title width_25p" BindText='bbsp_DataClassQueuemh' width="198"></td> 
