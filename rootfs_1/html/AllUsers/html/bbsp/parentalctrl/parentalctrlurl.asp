...
{	
    ...
    if (CfgModeflag === 'DESKAPASTRO') {
        $('.width_per20').css("width", "31%");
        $('.func_spread').css("height", "0px");
        $('#buttonReturn').css("width", "0");
        $('.align_right').css("text-align", "left");
        $('#DivUrlTitle').css("font-weight", "normal");
    }
}
 	...
 	<div id="divConfigUrlForm">
		...
		<div class="list_table_spread"></div>
			<form id="TableConfigInfo" style="display:block;"> 
				<table border="0" cellpadding="0" cellspacing="1"  width="100%"> 
					<li   id="UrlValue"    RealType="TextBox"          DescRef="bbsp_urladdrmh"         RemarkRef="Empty"     ErrorMsgRef="Empty"    Require="TRUE"     BindField="x.UrlAddress"      InitValue="Empty"     MaxLength='255'/>
				</table>
				<script language="JavaScript" type="text/javascript">
