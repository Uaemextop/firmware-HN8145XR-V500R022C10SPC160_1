...
function RefreshStatistics()
{
	$.ajax({
            ...
            QosSmartList = dealDataWithStr(data, 'GetQosSmartData();');
...
var QossmartConfiglistInfo = new Array(new stTableTileInfo("bbsp_CountEnable","align_center","DomainBox"),
									...
									new stTableTileInfo("bbsp_qossmartdestipmask","align_center restrict_dir_ltr","DestIPMask", false,"",0),
									new stTableTileInfo("bbsp_qossmartsrcipmask","align_center restrict_dir_ltr","SourceIPMask", false,"",0),
