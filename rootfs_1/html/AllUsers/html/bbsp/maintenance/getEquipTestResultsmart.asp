function() {
  function SelfTestResultClass(domain, SD5113Result, WifiResult, ExtLswResult, CodecResult, OpticResult, Port1Result, Port2Result, Port3Result, Port4Result, Port5Result, Port6Result, ExtRfResult, DECTResult)
  {
    this.domain = domain;
    ...
    this.ExtRfResult = ExtRfResult;
    this.DECTResult = DECTResult;
  }
  ...
  function EquipTestResultClass(SD5113Result, WifiResult, ExtLswResult, CodecResult, OpticResult, Port1Result, Port2Result, Port3Result, Port4Result, Port5Result, Port6Result, LinkTestResult, ExtRfResult, DECTResult)
  {
    this.SD5113Result = SD5113Result;
    this.WifiResult = WifiResult;
    this.LswResult = ExtLswResult;
