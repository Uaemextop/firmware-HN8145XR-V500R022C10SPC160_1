...
<script language="JavaScript" src="../../../resource/<%HW_WEB_Resource(bbspdes.html, e8c_selftest_language);%>"></script>
...
function EquipTestResult()
{
	...
	if (LinkResult.indexOf("NoCheck") >= 0 || top.isHasClickedCheckBtn == false)
	{
		ShowStr = "";
	}
