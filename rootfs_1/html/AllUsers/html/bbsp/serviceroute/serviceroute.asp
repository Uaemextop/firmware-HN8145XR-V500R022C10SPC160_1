...
<script language="JavaScript" type="text/javascript">
    var titleRef = 'bbsp_serroute_title';
    if (CfgModeflag === 'DESKAPASTRO') {
        titleRef = "bbsp_serroute_title_astro";
    }
	HWCreatePageHeadInfo("serviceroutetitle", GetDescFormArrayById(serroute_language, "bbsp_mune"), GetDescFormArrayById(serroute_language, titleRef), false);
</script> 
