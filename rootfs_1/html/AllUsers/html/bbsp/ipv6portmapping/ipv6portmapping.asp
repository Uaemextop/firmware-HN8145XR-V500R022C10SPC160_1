...
var g_bondingDomain = "";
var isDbaa1 = "<%HW_WEB_GetFeatureSupport(HW_SSMP_FEATRUE_DBAA1);%>" == 1;
...
function setCtlDisplay(record)
{
	...
	if (((isSupportHybrid == "1") && (record.domain.indexOf("X_HW_Bonding") > -1)) || isDbaa1) {
...
var PortMappingCfgListInfo = new Array(new stTableTileInfo("Empty","align_center","DomainBox"),
                                ...
                                new stTableTileInfo("bbsp_wanname","align_center restrict_dir_ltr","Interface", isDbaa1),
...
if (isSupportHybrid == 1) {
    $("#PortMappingInterface").append('<option value="Bonding" id="BONDING">' + ipv6portmapping_language['bbsp_bonding'] + '</option>');
}
