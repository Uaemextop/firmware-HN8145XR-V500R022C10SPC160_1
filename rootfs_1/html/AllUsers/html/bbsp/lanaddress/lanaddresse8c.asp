...
function RaConfigInfoClass(domain, ManagedFlag, OtherConfigFlag, mode,minRaInterval,maxRaInterval,Enable,MTU)
{
    this.domain = domain;
...
var Temp4 = <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_GetRaConfig, InternetGatewayDevice.LANDevice.1.X_HW_RouterAdvertisement, ManagedFlag|OtherConfigFlag|mode|MinRtrAdvInterval|MaxRtrAdvInterval|Enable|MTU, RaConfigInfoClass);%>;  
...
function BindPageData()
{
    ...
    if (fttrflag == 1) {
        setDisplay("tablPrefix", 1);
        setCheck("PrefixAssignment_checkbox", RaConfig.Enable); 
    }
    ...
    if ((CurBinMode.toUpperCase() == 'CMCC') || (CurBinMode.toUpperCase() == 'E8C')) {
...
function OnApplyButtonClick()
{
    ...
    if (fttrflag == 1) {
        var paEnable = getCheckVal("PrefixAssignment_checkbox");
...
function SetPrefixAssignmentEn(en)
{
    if (fttrflag == 1) {
        if (getCheckVal("PrefixAssignment_checkbox") == '0') {
...
<form id="ConfigForm"> 
  ...
  <table border="0" cellpadding="0" cellspacing="0"  width="100%"> 
	...
	<div class="func_spread"></div>
    <table id= "tablPrefix" border="0" cellpadding="0" cellspacing="0" width="100%" style="display:none;"> 
        <tr><td class="table_title"><input id="PrefixAssignment_checkbox" type="checkbox" onclick="SetPrefixAssignmentEn(this.checked);" name="PrefixAssignment_checkbox" value="true">使能路由通告</td></tr>
    </table>
    <table border="0" cellpadding="0" cellspacing="0"  width="100%"> 
    ...
    <table border="0" cellpadding="0" cellspacing="0"  width="100%"> 
        ...
        <tr id="IAPDAddLength" style="display: none;">
            ...
            <td class="table_right"><input type=text id="IAPDAddLength_text" class="width_254px" maxlength="19" />
                <font color="red">*</font><span id="" class="gray">
                    <script>document.write(lan_address_language['bbsp_valid_prefix_len']);</script>
                </span>
            </td>
        </tr>
    </table>
