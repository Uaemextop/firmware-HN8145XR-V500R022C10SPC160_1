...
<script language="javascript">
    ...
    function OnUrlEnableClick(UrlEnableControl)
    {
        ...
        Form.setAction('set.cgi?' +'x=InternetGatewayDevice.X_HW_Security.ParentalCtrl.Templates.1' + '&RequestFile=html/bbsp/urlfiltersetting/urlfiltersettingcnt.asp');
        Form.submit();
    }
    ...
    function OnDeleteBtClick()
    {
        ...
        Form.addParameter('x.X_HW_Token', getValue('onttoken'));
        Form.setAction('del.cgi?&RequestFile=html/bbsp/urlfiltersetting/urlfiltersettingcnt.asp');
        Form.submit();
    }
    ...
    function OnBtAddUrlClick(BtAddUrlControl)
    {
        ...
        Form.addParameter('x.X_HW_Token', getValue('onttoken'));	
        Form.setAction('add.cgi?' +'x=InternetGatewayDevice.X_HW_Security.ParentalCtrl.Templates.1.UrlFilter' + '&RequestFile=html/bbsp/urlfiltersetting/urlfiltersettingcnt.asp');
        Form.submit();
        DisableRepeatSubmit();
    }
