...
<script language="JavaScript" src="../../../resource/<%HW_WEB_Resource(bbspdes.html, portmapping_language);%>"></script>
...
var IsZQFlag = '<%HW_WEB_GetFeatureSupport(HW_FEATURE_ZQ);%>';
...
var TELMEX = false; 
if (curCfgModeWord.toUpperCase() == "A8C" &&  IsZQFlag) {
	PublicIpFlag = 0;
}
...
var WanIPPortMapping = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.WANDevice.{i}.WANConnectionDevice.{i}.WANIPConnection.{i}.PortMapping.{i},PortMappingEnabled|PortMappingProtocol|RemoteHost|ExternalPort|ExternalPortEndRange|InternalPort|X_HW_InternalEndPort|InternalClient|X_HW_ExternalSrcPort|X_HW_ExternalSrcEndPort|PortMappingDescription|X_HW_ExternalIP,stPortMap);%>;
var WanPPPPortMapping = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.WANDevice.{i}.WANConnectionDevice.{i}.WANPPPConnection.{i}.PortMapping.{i},PortMappingEnabled|PortMappingProtocol|RemoteHost|ExternalPort|ExternalPortEndRange|InternalPort|X_HW_InternalEndPort|InternalClient|X_HW_ExternalSrcPort|X_HW_ExternalSrcEndPort|PortMappingDescription|X_HW_ExternalIP,stPortMap);%>; 
...
function CheckPortMapping() 
{
   ...
   if(getElement("radiosrv")[1].checked == true && getElById(realConstSrvName).selectedIndex == 0)
   {
    ...
    {      
		...
		if ((getValue('ExternalEndPort').charAt(0) != '0') && (getValue('ExternalPort').charAt(0) != '0') && (parseInt(getValue('ExternalEndPort'),10) < parseInt(getValue('ExternalPort'),10)))
        {
	        AlertEx(portmapping_language['bbsp_extstartportleqendport'] + "(" + parseInt(getValue('ExternalPort'),10) + ")");
	        return false;     	
        }
	
	    if ((getValue('InternalEndPort').charAt(0) != '0') && (getValue('InternalPort').charAt(0) != '0') && (parseInt(getValue('InternalEndPort'),10) < parseInt(getValue('InternalPort'),10)))
        {
	       AlertEx(portmapping_language['bbsp_intstartportleqendport'] + "(" + parseInt(getValue('InternalPort'),10) + ")");
	       return false;     	
        }
	    if ((getValue('ExternalSrcEndPort').charAt(0) != '0') && (getValue('ExternalSrcPort').charAt(0) != '0') && (parseInt(getValue('ExternalSrcEndPort'),10) < parseInt(getValue('ExternalSrcPort'),10)))
        {
	       AlertEx(portmapping_language['bbsp_extsrcstartleqendport'] + "(" + parseInt(getValue('ExternalSrcPort'),10) + ")");
	       return false;     	
        }
    }
...
function ShowPortMapping()
{
   ...
   for (i = 0; i < PortMapping.length; i++)
   {
	    if (PortMapping[i].domain.indexOf(getSelectVal('PortMappingInterface')) > -1)
		{
			...
			html +=  '<TD >' + htmlencode(PortMapping[i].Protocol) + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].RemoteHost) + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].ExPort) + '-' + htmlencode(PortMapping[i].ExEndPort) + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].InPort) + '-' + htmlencode(PortMapping[i].InEndPort) + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].InClient) + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].ExSrcPort) + '-' + '&nbsp;</TD>';
			html += '<TD >' + htmlencode(PortMapping[i].ExSrcEndPort) + '&nbsp;</TD>';
			if (PortMapping[i].ProtMapEnabled == 1)
			{
...
function ShowPortMap()
{
	...
	{  
	   ...
	   if((GetCfgMode().PCCWHK == "1") && (ipjudge2[0] == 192) && (ipjudge2[1] == 168) && (ipjudge2[2] == 8) && (ipjudge2[3] > 127 ))
	   {
		...
		{
		html +=  '<TD title="' + ShowNewRow(htmlencode(PortMapping[i].Description)) +'">' + GetStringContent(htmlencode(PortMapping[i].Description),16) + '</TD>';
		}
...
<form id="PortMappingForm" name="PortMappingForm"> 
<script language="JavaScript" type="text/javascript">
	HWCreatePageHeadInfo("portmappingoldtitle", GetDescFormArrayById(portmapping_language, "bbsp_mune"), GetDescFormArrayById(portmapping_language, "bbsp_portmapping_title"), false);
</script> 
<div class="title_spread"></div>
  ...
  <div class="list_table_spread"></div>
        ...
        <td> <div id="PortMappingDiv"> 
            <table cellpadding="2" cellspacing="1" class="tabal_bg" width="100%"> 
              <tr id="typeTR" style="display: none"> 
                <td class="table_title width_per18" BindText='bbsp_typemh'></td> 
                <td class="table_right width_per28"> <input type="radio" id="radiosrv" name="radiosrv" onclick='radioClick();' checked="true" value="1"> 
                  <script>document.write(portmapping_language['bbsp_custom']);</script></td> 
                <td class="table_title width_per18"> <input type="radio" name="radiosrv" onclick='radioClick();' value="2"> 
                  <script>document.write(portmapping_language['bbsp_application']);</script></td> 
                <td class="table_right width_per28"> 
              ...
              <tr > 
                <td class="table_title width_per18" style="display" BindText='bbsp_enablemappingmh'></td> 
                <td class="table_right width_per28"> <input type='checkbox' id='PortMappingEnable' name='PortMappingEnable' > </td> 
                <td class="table_title width_per18" ></td> 
                <td class="table_right width_per28"></td> 
              </tr>
              <tr> 
                <td class="table_title width_per18" BindText='bbsp_wannamemh'></td> 
                <td class="table_right width_per28" id="PortMappingInterfacetitle"> <select id="PortMappingInterface" name='PortMappingInterface' size="1" onChange="ShowPortMapping()" 
                                    style="width: 133px"> 
                    <script language="JavaScript" type="text/javascript">
                ...
                <td class="table_title width_per18" BindText='bbsp_protocolmh'></td> 
                <td class="table_right width_per28"> <select id='PortMappingProtocol' name='PortMappingProtocol' size="1" style="width: 133px"> 
              ...
              <tr> 
                <td class="table_title width_per18" BindText='bbsp_extstartportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='ExternalPort' name='ExternalPort' size='20' maxlength='5'> 
                  <strong style="color:#FF0033">*</strong> </td> 
                <td class="table_title width_per18" BindText='bbsp_extendportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='ExternalEndPort' name='ExternalEndPort' size='20' maxlength='5'> 
                  <strong style="color:#FF0033">*</strong> </td> 
              </tr> 
              <tr> 
                <td class="table_title width_per18" BindText='bbsp_intstartportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='InternalPort' name='InternalPort' size='20' maxlength='5'> 
                  <strong style="color:#FF0033">*</strong> </td> 
                <td class="table_title width_per18" BindText='bbsp_intendportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='InternalEndPort' name='InternalEndPort' size='20' maxlength='5'> </td> 
              </tr> 
              <tr > 
                <td class="table_title width_per18" BindText='bbsp_extsrcstartportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='ExternalSrcPort' name='ExternalSrcPort' size='20' maxlength='5'> </td> 
                <td class="table_title width_per18" BindText='bbsp_extsrcendportmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='ExternalSrcEndPort' name='ExternalSrcEndPort' size='20' maxlength='5'> </td> 
              </tr> 
              <tr > 
                <td class="table_title width_per18" BindText='bbsp_mappingmh'></td> 
                <td class="table_right width_per28"> <input type='text' id='PortMappingDescription' name='PortMappingDescription' size='20' maxlength='31'>
					<script>
						if (true == TELMEX)
						{
                ...
                <td class="table_title width_per18" BindText='bbsp_extsrcipmh'> </td> 
                <td class="table_right width_per28"> <input id="RemoteHost" type='text' name='RemoteHost' size='20' maxlength='15'> </td> 
              </tr> 
              <tr>
                ...
                <td class="table_right width_75p" colspan="3" > <input type='text' id='InternalClient' name='InternalClient' size='20' maxlength='32'> 
                  <strong style="color:#FF0033" id="portmapselectinfotable">*</strong>
                    	  ...
                    	  {
                            var output = '<select name=' + "'HostName'" + ' id=' + "'HostName'" + ' size="1" onChange=' + "'HostNameChange()'" + ' class="width_123px" style="margin-left:20px">';
                            for (i = 0; i < LANhostName.length; i++)
                            {
                                output = output + '<option value="' + i + '" title="'+htmlencode(LANhostName[i])+'">' + GetStringContent(htmlencode(LANhostName[i]),30) + '</option>';			   
                            } 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding: 10px 0px 10px 0;"> 
      <tr> 
        <td class="align_center pad_top5p"> 
