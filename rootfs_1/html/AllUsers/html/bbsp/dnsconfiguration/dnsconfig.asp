...
{    
	...
	if( 0 != Count)
	{
		Form.setAction('del.cgi?x=InternetGatewayDevice.X_HW_DNS.HOSTS&RequestFile=html/bbsp/dnsconfiguration/dnsconfig.asp');
...
{ 	
	...
	var Form = new webSubmitForm();
	var urlsubmit =  action + '&RequestFile=html/bbsp/dnsconfiguration/dnsconfig.asp'; 
