...
var getDhcpV6TitleId = function() {
    if (CfgModeflag === 'DESKAPASTRO') {
        return 'bbsp_dhcpv6_staticip_title2_astro';
    }

    if (RaConfig && RaConfig.ManagedFlag == 0) {
        return 'bbsp_dhcpv6_staticip_title2';
    }

    return 'bbsp_dhcpv6_staticip_title';
}

HWCreatePageHeadInfo("dhcpstaticaddress", GetDescFormArrayById(dhcpv6_staticip_language, "bbsp_mune"), GetDescFormArrayById(dhcpv6_staticip_language, getDhcpV6TitleId()), false);
</script>
