function() {
    ...
    function WanIP(domain, Enable, Status, Mode, X_HW_SERVICELIST, X_HW_ExServiceList, X_HW_IPv4Enable, X_HW_IPv6Enable, AddressingType, ExternalIPAddress, MacId) {
        this.domain = domain;
        this.Enable = Enable;
        this.Status = Status;
        this.Mode = Mode;
    ...
    function WanPPP(domain, Enable, Status, Mode, IPAddress, ServiceList, ExServiceList, IPv4Enable, IPv6Enable, MacId) {
        this.domain = domain;
        this.Enable = Enable;
        this.Status = Status;
        this.Mode = Mode;
    ...
    var IPWanList = <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_SpecParaArrayIPWAN, InternetGatewayDevice.WANDevice.{i}.WANConnectionDevice.{i}.WANIPConnection.{i}, Enable|ConnectionStatus|ConnectionType|X_HW_SERVICELIST|X_HW_ExServiceList|X_HW_IPv4Enable|X_HW_IPv6Enable|AddressingType|ExternalIPAddress|X_HW_MacId, WanIP);%>;

    var PPPWanList = <%HW_WEB_GetSpecParaArryByDomain(HW_WEB_SpecParaArrayPPPWAN, InternetGatewayDevice.WANDevice.{i}.WANConnectionDevice.{i}.WANPPPConnection.{i}, Enable|ConnectionStatus|ConnectionType|ExternalIPAddress|X_HW_SERVICELIST|X_HW_ExServiceList|X_HW_IPv4Enable|X_HW_IPv6Enable|X_HW_MacId,WanPPP);%>;
