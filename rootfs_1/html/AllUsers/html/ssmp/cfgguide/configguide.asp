...
<table width="100%" border="0" cellpadding="0" cellspacing="1" id="Wizard1Panel" class="tabal_bg">
  ...
  <tr>
	...
	<td class="table_right width_per75"> <input type="password" autocomplete="off" id="pppoe_wan_pwd" maxlength="63" > </td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<tr>
		...
		<td class="table_right width_per75">
		<input type='password' autocomplete="off" id='Wizard_password02_password' name='Wizard_password02_password' style="width:123px" maxlength='64' class="amp_font"  onchange="" />
...
function showallconfigdata()
{
	...
	document.getElementById('internet_user').innerHTML= htmlencode(getValue('pppoe_wan_name'));
	document.getElementById('internet_pwd').innerHTML= htmlencode(getValue('pppoe_wan_pwd'));

	if (true == IsWlanAvailable())
	{
		setDisplay('wlaninfo', 1);
		document.getElementById('wlan_enable').innerHTML= htmlencode(GetWlanEnable());
		document.getElementById('wlan_ssid').innerHTML= htmlencode(getValue('Wizard_text02_text'));
		document.getElementById('wlan_psk').innerHTML= htmlencode(getValue('Wizard_password02_password'));
	}
}
