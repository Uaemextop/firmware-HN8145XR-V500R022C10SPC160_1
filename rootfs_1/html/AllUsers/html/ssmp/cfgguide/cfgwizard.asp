...
function OnfinishStep()
{
	...
	if (getCheckVal("Wizard_checkbox04_checkbox") == 1)
	{
		Form.addParameter('x.Password',base64encode(FormatUrlEncode(getValue('Wizard_password04_02_password'))));	
		Form.addParameter('x.OldPassword',base64encode(FormatUrlEncode(getValue('Wizard_password04_01_text'))));	
