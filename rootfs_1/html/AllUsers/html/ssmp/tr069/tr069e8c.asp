...
{   
	with(document.getElementById("ConfigForm"))
    {
        ...
        if ('' != isValidAscii(AcsPassWord_password.value))
        {
            AlertEx("无效的ITMS认证密码。");
            AcsPassWord_password.focus();
            return false;
        ...
        if ('' != isValidAscii(ConnReqPassWord_password.value))
        {
            AlertEx("无效的反向认证密码。");
            ConnReqPassWord_password.focus();
            return false;
...
function AddSubmitParam(SubmitForm,type)
{
	...
	if (getValue('ConnReqPassWord_password') != MASK)
    {   
...
<div class="func_spread"></div>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_bg"> 
    ...
    <tr> 
      ...
      <td class="table_right" colspan="8" align="left"> <input name='AcsPassWord_password' type='password' autocomplete='off' id="AcsPassWord_password" size="20" maxlength="256"> 
    ...
    <tr> 
      ...
      <td class="table_right" colspan="8"> <input name='ConnReqPassWord_password' type='password' autocomplete='off' id="ConnReqPassWord_password" size="20"  maxlength="256"> 
