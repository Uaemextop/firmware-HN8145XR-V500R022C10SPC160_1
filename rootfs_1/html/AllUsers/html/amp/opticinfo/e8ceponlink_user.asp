...
function OpticInfo(domain,transOpticPower,revOpticPower,uwTxPower,uwRxPower)
{
    this.Domain = domain;
...
var OpticInfoList = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.X_HW_DEBUG.AMP.Optic,TxPower|RxPower|uwTxPower|uwRxPower, OpticInfo);%>; 
