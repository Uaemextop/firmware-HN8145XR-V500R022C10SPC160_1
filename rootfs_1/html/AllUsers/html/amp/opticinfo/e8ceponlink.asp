...
<div style=" margin-left:20px;  margin-right:10px; position:inherit; height:100%">
<script>
function LoadFrame()
{
}

function EPONLinkStatus(domain, FECEnable, FECSupport)
{
    this.Domain = domain;
	this.FECEnable = FECEnable;
	this.FECSupport = FECSupport;
}

function OpticInfo(domain,transOpticPower,revOpticPower,voltage,temperature,bias,uwTxPower,uwRxPower)
{
    this.Domain = domain;
	...
	this.Bias = bias;
	this.uwTxPower = uwTxPower;
	this.uwRxPower = uwRxPower;
}
...
var EponLinkStateList = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.X_HW_DEBUG.AMP.EPONLinkInfo, FECEnable|FECSupport, EPONLinkStatus);%>;
...
var EponLinkState = EponLinkStateList[0];
...
<table id="table_ponstatustitle" width="100%">
	<tr>
		<td class="prompt">
		<label id="Title_pon_satus_lable" class="title_common">在本页面上，您可以查询网络侧连接信息。</label>
		</td>
	</tr>
	<tr>
		<td  style="height:5px;">
...
<table class="tabal_bg" width="100%" id="TableEponInfo" name="table1" cellspacing="1">
	...
	<tr>
	  <td align="left" id="Table_pon3_1_table" name="Table_pon3_1_table" class="table_left" >FEC能力:</td>
	  <td id="Table_pon3_2_table" name="Table_pon3_2_table" class="table_right">
		  <div id="FecSupport" class="table_right"></div></td>
	</tr>
	
	<tr>
	  <td align="left" id="Table_pon4_1_table" name="Table_pon4_1_table" class="table_left" >FEC状态:</td>
	  <td id="Table_pon4_2_table" name="Table_pon4_2_table" class="table_right">
		  <div id="FecEnable" class="table_right"></div></td>
	</tr>
</table>
...
<table class="tabal_bg" width="100%" id="TableOpticalInfo" name="table2"  cellspacing="1">
	...
	<tr>
		<td width="150px" align="left" id="Table_pon12_1_table" name="Table_pon12_1_table" class="table_left">工作电压:</td>
		<td id="Table_pon12_2_table" name="Table_pon12_2_table" class="table_right">
		<div id="WorkVoltage" class="table_right"></div>
		</td>
	</tr>

	<tr>
		<td width="150px" align="left" id="Table_pon13_1_table" name="Table_pon13_1_table" class="table_left">工作电流:</td>
		<td id="Table_pon13_2_table" name="Table_pon13_2_table" class="table_right">
		<div id="WorkBias" class="table_right"></div>
		</td>
	</tr>

	<tr>
		<td align="left"  class="table_left" id="Table_pon14_1_table" name="Table_pon14_1_table">工作温度:</td>
		<td id="Table_pon14_2_table" name="Table_pon14_2_table" class="table_right">
		<div id="WorkTemperature" class="table_right"></div>
		</td>
	</tr>
</table>
 
<table class="tabal_bg" width="100%" id="TableOLTOpticalInfo" name="table3" cellspacing="1" style="display:none">
	<tr  class="table_title">
...
function FillLinkInfo()
{
	...
	SetDivValue("FecEnable", GetFecEnable(EponLinkState.FECEnable));
	SetDivValue("FecSupport", GetFecSupport(EponLinkState.FECSupport));
}
try
{
	FillLinkInfo();
...
var OpticInfoList = <%HW_WEB_GetParaArryByDomain(InternetGatewayDevice.X_HW_DEBUG.AMP.Optic,TxPower|RxPower|Voltage|Temperature|Bias|uwTxPower|uwRxPower, OpticInfo);%>; 
...
function FillOpticInfo()
{
	...
	{
		SetDivValue("SendPower", OpticInfo.uwTxPower+"（单位：0.1μw）， "+OpticInfo.TransOpticPower+"（单位：dBm）");
		SetDivValue("ReceivePower", OpticInfo.uwRxPower+"（单位：0.1μw）， "+OpticInfo.RevOpticPower+"（单位：dBm）");
	}
	else
	{
	...
	SetDivValue("WorkVoltage", OpticInfo.Voltage+"mV");
	SetDivValue("WorkBias", OpticInfo.Bias+"mA");
	SetDivValue("WorkTemperature", OpticInfo.Temperature+"℃");
}
try
{
	FillOpticInfo();
...
function FillOLTOpticInfo()
{
	...
	getElById("TableOLTOpticalInfo").style.display = "";
